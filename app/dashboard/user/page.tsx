...
export default function UserDashboard() {
  ...
  const approvedCount = evacuations.filter((e) => e.status === 'approved').length;
  const completedCount = evacuations.filter((e) => e.status === 'completed').length;
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
          <Card className="bg-gradient-to-br from-card to-card/50">
            ...
            <CardContent>
              ...
              <p className="text-xs text-muted-foreground mt-1">Total evacuations</p>
            </CardContent>
          </Card>
          ...
          <Card className="bg-gradient-to-br from-green-50 to-green-50/50 dark:from-green-950/20 dark:to-green-950/10 border-green-200 dark:border-green-800">
            ...
            <CardContent>
              <div className="text-3xl font-bold text-green-700 dark:text-green-500">{approvedCount}</div>
              <p className="text-xs text-green-700 dark:text-green-400 mt-1">Approved requests</p>
            </CardContent>
          </Card>
          ...
          <Card className="bg-gradient-to-br from-blue-50 to-blue-50/50 dark:from-blue-950/20 dark:to-blue-950/10 border-blue-200 dark:border-blue-800">
            <CardHeader className="pb-2">
              <CardTitle className="text-sm font-medium text-blue-900 dark:text-blue-100">Completed</CardTitle>
            </CardHeader>
            <CardContent>
              <div className="text-3xl font-bold text-blue-700 dark:text-blue-500">{completedCount}</div>
              <p className="text-xs text-blue-700 dark:text-blue-400 mt-1">Completed evacuations</p>
            </CardContent>
          </Card>
        </div>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Track all your medical evacuation requests</CardDescription>
          </CardHeader>
